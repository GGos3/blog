...
const Article=(0,stitches_config/* styled */.I4)('article',{position:'relative','& .heading-anchor':{borderBottom:0,svg:{fill:'$text500'}}});const TableOfContents=(0,stitches_config/* styled */.I4)('div',{marginBottom:'1.5rem','> ul':{marginLeft:0},ul:{listStyle:'none',li:{paddingTop:'0.125rem',paddingBottom:'0.125rem',color:'$text200',fontSize:'0.875rem',transition:'color $transitionDuration $transitionTiming',a:{textDecoration:'underline'}}}});const Header=(0,stitches_config/* styled */.I4)('header',{marginBottom:'2rem'});const Title=(0,stitches_config/* styled */.I4)('h1',{fontSize:'2.25rem'});const ArticleMetadata=(0,stitches_config/* styled */.I4)('div',{display:'flex',alignItems:'center',marginTop:'0.5rem',color:'$text200',fontWeight:700,transition:'color $transitionDuration $transitionTiming'});const Content=(0,stitches_config/* styled */.I4)('section',{wordBreak:'keep-all',h1:{marginTop:'2rem',marginBottom:'1.25rem',paddingBottom:'0.25rem',borderBottom:'1px solid $borderGray',a:{borderBottom:'none'}},h2:{marginTop:'1.5rem',marginBottom:'1rem',paddingBottom:'0.25rem',borderBottom:'1px solid $borderGray',a:{borderBottom:'none'}},h3:{marginTop:'1.5rem',marginBottom:'0.75rem'},a:{borderBottom:'1px solid $borderPrimary',color:'$link',transition:'color $transitionDuration $transitionTiming, border-bottom-color $transitionDuration $transitionTiming'},pre:{code:{wordBreak:'break-all',overflowWrap:'break-word',backgroundColor:'transparent'}},code:{backgroundColor:'$borderGray'},'pre, code':{fontVariantLigatures:'none'}});const Footer=(0,stitches_config/* styled */.I4)('footer',{'&:before':{display:'block',width:'100%',height:'0.2rem',margin:'3rem auto',backgroundColor:'$primary200',transition:'background-color $transitionDuration $transitionTiming',content:''}});
