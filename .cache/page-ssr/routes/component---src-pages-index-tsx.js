...
const ArticleList=({posts})=>{return/*#__PURE__*/index_js_default().createElement(styles_Container,null,/*#__PURE__*/index_js_default().createElement("ul",null,posts.map(post=>{var _ref,_post$frontmatter$tit,_post$frontmatter,_post$fields,_post$fields$slug,_post$fields2,_ref2,_post$frontmatter$des,_post$frontmatter2;if(post===undefined){return null;}const title=(_ref=(_post$frontmatter$tit=(_post$frontmatter=post.frontmatter)===null||_post$frontmatter===void 0?void 0:_post$frontmatter.title)!==null&&_post$frontmatter$tit!==void 0?_post$frontmatter$tit:(_post$fields=post.fields)===null||_post$fields===void 0?void 0:_post$fields.slug)!==null&&_ref!==void 0?_ref:'';const slug=(_post$fields$slug=(_post$fields2=post.fields)===null||_post$fields2===void 0?void 0:_post$fields2.slug)!==null&&_post$fields$slug!==void 0?_post$fields$slug:'';const description=(_ref2=(_post$frontmatter$des=(_post$frontmatter2=post.frontmatter)===null||_post$frontmatter2===void 0?void 0:_post$frontmatter2.description)!==null&&_post$frontmatter$des!==void 0?_post$frontmatter$des:post.excerpt)!==null&&_ref2!==void 0?_ref2:'';return/*#__PURE__*/index_js_default().createElement(Item,{key:slug,title:title,slug:slug,description:description});})));};/* harmony default export */ const components_ArticleList = (/*#__PURE__*/(0,index_js_.memo)(ArticleList));
