...
export const onRenderBody = ({ setHeadComponents, setPostBodyComponents }: RenderBodyArgs) => {
  setHeadComponents([
    <style
      key='stitches'
      id='stitches'
        ...
        __html: `
          document.addEventListener('DOMContentLoaded', function() {
            ...
            codeBlocks.forEach((preBlock) => {
              ...
              button.className = 'copy-button hidden';
              button.innerHTML = \`
                ...
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="check-icon hidden">
              ...
              button.addEventListener('click', () => {
                ...
                const lines = Array.from(codeBlock.querySelectorAll('.grvsc-line')).map(line => {
                  return line.textContent.trim(); // Trim each line
                ...
                navigator.clipboard.writeText(lines)
                  .then(() => {
                    ...
                    }, 3000); // Show check icon for 3 seconds
                  })
